...
<div
id="mobile-menu"
class="rounded-lg shadow-[#ccc] shadow-2xl hidden flex-col space-y-4 justify-center items-center md:hidden w-32 top-[100px] z-10 left-1 h-max p-20 absolute bg-white"
>
<a
  href=" /"
